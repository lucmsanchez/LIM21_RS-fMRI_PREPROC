...
if [[ "$s1" == "bet" ]]; then
    ...
    fsl5.0-bet ${iopt} ${i}_step1 -B -f 0.25
else
...
fsl5.0-flirt -ref ${FSLDIR}/data/standard/MNI152_T1_2mm_brain -in ${i}_step1.nii.gz -omat ${i}_step2.mat -out ${i}_step2 -searchrx -30 30 -searchry -30 30 -searchrz -30 30
...
fsl5.0-fnirt --in=${i} --aff=${i}_step2.mat --cout=${i}_step3 --config=T1_2_MNI152_2mm
...
fsl5.0-applywarp --ref=${FSLDIR}/data/standard/MNI152_T1_2mm --in=${i} --warp=${i}_step3 --out=${i}_step4
...
fsl5.0-invwarp -w ${i}_step3.nii.gz -o ${i}_step5.nii.gz -r ${i}_step1.nii.gz
...
fsl5.0-applywarp --ref=${i} --in=${FSLDIR}/data/standard/${mask} --warp=${i}_step5.nii.gz --out=${i}_step6 --interp=nn
...
fsl5.0-fslmaths ${i}_step6.nii.gz -bin ${i}_optiBET_brain_mask
...
fsl5.0-fslmaths ${i} -mas ${i}_optiBET_brain_mask ${i}_optiBET_brain
